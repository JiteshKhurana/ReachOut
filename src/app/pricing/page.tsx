...
const PricingCard = ({
  ...
  <Card
    className={cn(
      `w-72 flex flex-col justify-between py-1 Rs {
      ...
      <CardHeader className="pb-8 pt-4">
        {isYearly && yearlyPrice && monthlyPrice ? (
          <div className="flex justify-between">
            ...
            >
              Save Rs {monthlyPrice * 12 - yearlyPrice}
            </div>
          </div>
        ) : (
          <CardTitle className="text-zinc-700 dark:text-zinc-300 text-lg">
  ...
  const plans = [
    {
      ...
      monthlyPrice: 0,
      yearlyPrice: 0,
      description: "Connect with students for shared taxi rides",
      features: [
    ...
    },
    {
      ...
      features: [
        ...
        "Extra 10% off upto Rs 50 on all rides",
